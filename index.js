...
server.tool("glob-search", GlobSearchSchema.shape, async (params, extra) => {
    var _a;
    try {
        ...
        if (axios.isAxiosError(error)) {
            throw new Error(`API Error: ${((_a = error.response) === null || _a === void 0 ? void 0 : _a.data) || error.message}`);
        }
        throw error;
    }
});
...
server.tool("get-docs", FQCNSchema.shape, async (params, extra) => {
    var _a;
    try {
